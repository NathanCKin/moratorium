# The name of this view in Looker is "Geo Data Locations"
view: geo_data_locations {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: public.geo_data_locations ;;
  drill_fields: [id]
  ...
  dimension: lookup_latlon {
    type: string
    sql: ${TABLE}."lookup_latlon" ;;
  }

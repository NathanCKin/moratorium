# The name of this view in Looker is "Renewal Endorsement Requests"
view: renewal_endorsement_requests {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: public.renewal_endorsement_requests ;;
  drill_fields: [id]
  ...
  dimension: renewal_id {
    type: number
    sql: ${TABLE}."renewal_id" ;;
  }

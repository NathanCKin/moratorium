# The name of this view in Looker is "Billing Draft Transactions"
view: billing_draft_transactions {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: public.billing_draft_transactions ;;
  drill_fields: [id]
  ...
  measure: count {
    type: count
    drill_fields: [id, renewal_endorsement_requests.id, endorsement_requests.id]
  }
}

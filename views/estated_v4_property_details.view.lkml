# The name of this view in Looker is "Estated V4 Property Details"
view: estated_v4_property_details {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: public.estated_v4_property_details ;;
  drill_fields: [id]
  ...
  dimension: roof_material_type {
    type: string
    sql: ${TABLE}."roof_material_type" ;;
  }
